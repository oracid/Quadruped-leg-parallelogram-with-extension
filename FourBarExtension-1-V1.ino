//FourBarExtension-1 is a parallelogram leg with an extension. 08/03/2020
#include <Servo.h>
const int nbSrv=2;          // Number of servos
Servo Srv[nbSrv];           // Servos table
int SrvOn[nbSrv]={1,1};     // Servos table on/off. 1=on, 0=off
int Speed=60;               // here you can change the speed
int errL=0, errR=0;         // Here you need to correct the 0° position of your servos
...
//  HLine(-25,25,10);delay(300);             // draw an horizontal line from x=-30 to x=30 and y=10
//  HLine(25,-25,10);delay(300);             // draw an horizontal line from x=-30 to x=30 and y=10
}
